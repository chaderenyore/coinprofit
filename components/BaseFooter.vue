<template>
  <div class="main-footerWrapper">
      ...
      <div class="MF-wrapper">
        ...
        <div class="FAQfooterContainer">
          <div class="footerWrapper">
            <button class="footerToggle">
              <h3>Company</h3>
              <i
                class="fa fa-chevron-down footerIcon"
                style="color: #3374ea"
              ></i>
            </button>
            <div class="footerContent">
              <nuxt-link to="/about"><p>About Us</p></nuxt-link>
              <nuxt-link to="/blog"><p>Blog</p></nuxt-link>
              <nuxt-link :to="{ path: '/help', query: { purpose: 'contact' } }">
          ...
          <div class="footerWrapper">
            ...
            <div class="footerContent">
              <nuxt-link to="/help"><p>How to Guide</p></nuxt-link>
              <nuxt-link to="/academy"><p>Academy</p></nuxt-link>
            </div>
          </div>
          ...
          <div class="footerWrapper">
            ...
            <div class="footerContent">
              ...
              <nuxt-link to="/privacy_policy"><p>Privacy policy</p></nuxt-link>
              <nuxt-link to="/aml_policy"><p>AML Policies</p></nuxt-link>
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="copyright">
      <p>COINPROFIT.APP COPYRIGHT &copy; 2022 ALL RIGHTS RESERVED.</p>
    </div>
  </div>
</template>
    ...
    initFooter() {
      ...
      for (let i = 0; i < toggles.length; i++) {
        toggles[i].addEventListener("click", () => {
          if (
            parseInt(contentBox[i].style.height) != contentBox[i].scrollHeight
          ) {
