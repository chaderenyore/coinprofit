  ...
  <main v-if="post" class="pt-24 article-main">
    <teleport to="head">
      <template>
        ...
        <meta
          name="keywords"
          content="bitcoin, btc education, bitcoin trading, crypto tracking, track crypto assets, tracking, coinprofit academy"
        />
      </template>
    </teleport>
    <article
  ...
  export default {
    ...
    watch: {
      articleTitle(newValue, oldvalue_trash) {
        document.title = newValue[0].text + " - CoinProfit Academy";
