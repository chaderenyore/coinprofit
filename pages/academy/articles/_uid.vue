...
export default {
  ...
  async asyncData({ $prismic, params, error }) {
    const post = await $prismic.api.getByUID("academy", params.uid, {
  ...
  head() {
    return {
      title: this.post.data.article_title[0].text + " - Coinprofit Academy",
      meta: [
        {
          hid: "desc",
          name: "description",
        ...
        },
        {
          ...
          name: "keywords",
          content:
            "bitcoin,crypto tracking, track crypto assets, coinprofit Academy, eth, tracking, portfolio tracking",
        },
        {
          property: "og:title",
          content: this.post.data.article_title[0].text + " - Coinprofit Academy",
        },
        {
